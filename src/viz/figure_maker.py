"""Assemble paper figures from cached results: one method per figure, drawing
delegated to plot_* in src/viz. Missing input skips its figure."""
...
class FigureMaker:
    ...
    # lazy shared resources (recon grids only)
    @property
    def stores(self):
    ...
    def fig5(self):
        ...
        mu0 = anchor_badness(cube[:, :, 0])   # t=0 baseline
